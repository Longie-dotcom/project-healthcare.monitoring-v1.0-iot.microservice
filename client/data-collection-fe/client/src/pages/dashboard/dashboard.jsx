...
import RoomProfile from "../../component/data-collection/room-profile";
import PatientManagement from "../../component/data-collection/patient-management";
...
function Dashboard() {
  const tabs = [
    { id: "room-management", label: "Room management", component: <RoomProfile /> },
  ...
  return (
    <div id="dashboard">
      ...
      <div className="dashboard-sidebar">
        <h2 className="sidebar-logo">Data Service</h2>
