...
import PatientManagement from "../../component/patient-management/patient-management";
import PatientStatusManagement from "../../component/patient-status-management/patient-status-management";
...
function Dashboard() {
  const tabs = [
    { id: "patient-management", label: "Patient management", component: <PatientManagement /> },
    { id: "patient-status-management", label: "Status table", component: <PatientStatusManagement /> },
