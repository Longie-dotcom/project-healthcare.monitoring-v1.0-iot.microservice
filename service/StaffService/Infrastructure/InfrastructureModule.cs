    ...
    public static class InfrastructureModule
    {
                ...
                ILoggerFactory loggerFactory)
        {
            ...
            try
            {
                ...
                {
                    InfrastructureLoggerBase(
                        logger, "Missing environment variable: STAFF_DB_CONNECTION");
            ...
            try
            {
                ...
                services.AddMassTransit(x =>
                {
                    ...
                    x.UsingRabbitMq((context, cfg) =>
                    {
                        ...
                        cfg.ReceiveEndpoint("staff_update_user_consumer", e =>
                        {
                            e.ConfigureConsumer<UpdateUserConsumer>(context);
                        });

                        cfg.ReceiveEndpoint("staff_delete_user_consumer", e =>
                        {
