    ...
    public static class InfrastructureModule
    {
                ...
                ILoggerFactory loggerFactory)
        {
            ...
            try
            {
                ...
                {
                    InfrastructureLoggerBase(
                        logger, "Missing environment variable: PATIENT_DB_CONNECTION");
                    throw new DatabaseConnectionException(
                        "Failed to configure Patient database.");
                }
            ...
            {
                InfrastructureLoggerBase(
                    logger, "Failed to configure Staff database.", ex);
                throw new DatabaseConnectionException(
                    "Failed to configure Staff database.");
            }
            ...
            try
            {
                ...
                services.AddMassTransit(x =>
                {
                    ...
                    x.UsingRabbitMq((context, cfg) =>
                    {
                        ...
                        cfg.ReceiveEndpoint("patient_update_user_consumer", e =>
                        {
                            e.ConfigureConsumer<UpdateUserConsumer>(context);
                        });

                        cfg.ReceiveEndpoint("patient_delete_user_consumer", e =>
                        {
                    ...
                    services.AddScoped<IStaffAssignmentPublisher, StaffAssignmentPublisher>();
                });
            ...
            try
            {
                ...
                services.AddScoped<IIAMGrpcClient, IAMGrpcClient>();
                services.AddScoped<IDeviceManagementGrpcClient, DeviceManagementGrpcClient>();
